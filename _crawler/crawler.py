...
class crawler:
    ...
    def download(self, savePath: str, retryTimes: int = 3, eachSize: int = 16*MB, multi: bool = False) -> None:
        """
        ...
        # Progress bar
        bar = tqdm(total=fileSize, desc="Downloading: {}".format(self.url), unit="bits")
        for part in parts:
            start, end = part
